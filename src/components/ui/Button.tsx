...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-kigali-green text-white hover:bg-kigali-green/90 focus:ring-kigali-green',
      secondary: 'bg-kigali-blue text-white hover:bg-kigali-blue/90 focus:ring-kigali-blue',
